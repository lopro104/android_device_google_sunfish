...
define make-espimage-target
	$(hide) mkdir -p $(dir $(INSTALLED_SUNFISH_ESPIMAGE_TARGET))
	$(call pretty,"Target EFI System Partition image: $(INSTALLED_SUNFISH_ESPIMAGE_TARGET)")
	...
	cp $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/arch/arm64/boot/dts/qcom/sm7150-google-*.dtb $(ESP_OUT_DIR)/dtb/qcom/

	$(call create-fat32image,$(INSTALLED_SUNFISH_ESPIMAGE_TARGET),$(ESP_OUT_DIR)/* $(INSTALLED_SUNFISH_ESPIMAGE_TARGET_INCLUDE_FILES),EFI)
endef

$(INSTALLED_SUNFISH_ESPIMAGE_TARGET): $(INSTALLED_SUNFISH_ESPIMAGE_TARGET_DEPS)
	$(call make-espimage-target)

.PHONY: espimage
espimage: $(INSTALLED_SUNFISH_ESPIMAGE_TARGET)

.PHONY: espimage-nodeps
espimage-nodeps:
	@echo "make $(INSTALLED_SUNFISH_ESPIMAGE_TARGET): ignoring dependencies"
	$(call make-espimage-target)
