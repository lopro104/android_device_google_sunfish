...
BOARD_AVB_MAKE_VBMETA_SYSTEM_IMAGE_ARGS += --flag 3
...
BOARD_AVB_VBMETA_SYSTEM_KEY_PATH := vendor/evolution-priv/keys/releasekey.pem
BOARD_AVB_VBMETA_SYSTEM_ALGORITHM := SHA256_RSA2048
BOARD_AVB_VBMETA_SYSTEM_ROLLBACK_INDEX := $(PLATFORM_SECURITY_PATCH_TIMESTAMP)
BOARD_AVB_VBMETA_SYSTEM_ROLLBACK_INDEX_LOCATION := 1
BOARD_AVB_ALGORITHM := SHA256_RSA2048
BOARD_AVB_KEY_PATH := vendor/evolution-priv/keys/releasekey.pem
PRODUCT_DEFAULT_DEV_KEYS := vendor/evolution-priv/keys
